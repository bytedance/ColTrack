...
class STrack(BaseTrack):
    ...
    def activate(self, kalman_filter, frame_id):
        ...
        if frame_id == 1:
            ...
            self.track_cache.append((deepcopy(self.tlwh), self.score, frame_id))
...
class BoTSORT(object):
    def __init__(self, args, video_name, frame_rate=30):
        ...
        self.gmc = GMC(method=args.cmc_method, verbose=[video_name, args.ablation])
    ...
    def update(self, output_results):
        ...
        matches, u_track, u_detection_second = matching.linear_assignment(dists, thresh=self.args.match_thresh_second)
        for itracked, idet in matches:
