...
__all__ = ['evaluate_coco']


@EVALUATOR_REGISTRY.register()
@torch.no_grad()
def evaluate_coco(model, criterion, postprocessors, data_loader, base_ds, device, output_dir, wo_class_error=False, args=None, logger=None):
    try:
